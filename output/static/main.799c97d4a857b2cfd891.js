	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        wechatShareConfig: function () {
	            ...
	            $.ajax({
	                url: 'https://test-mhis-siapp.pingan.com.cn/mhis-siapp/open/wechat/getToken.do', //接口地址获取accessToken
	                data: {
	                    appId: appId,
	                    appSecret: appSecret
	                },
	                ...
	                success: function (response) {
	                    ...
	                    $.ajax({
	                        url: 'https://test-mhis-siapp.pingan.com.cn/mhis-siapp/open/wechat/getSingature.do', //接口地址获取签名
	                        data: {
	                            noncestr: noncestr,
